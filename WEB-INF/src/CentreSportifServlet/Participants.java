...
public class Participants extends HttpServlet {
    ...
    public void supprimerParticipant(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
    	try {
    		String matricule = request.getParameter("matricule");
    		if (matricule == null || matricule.equals(""))
                throw new IFT287Exception("Le matricule du participant doit être spécifié");
            ...
            synchronized (centreSportifUpdate) {
            	...
            	listeMessageSucces.add("Suppression du participant: " + matricule);
    ...
    public void ajouterJoueur(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
    	try {
    		String matricule = request.getParameter("matricule");
            ...
            // sur biblio
            synchronized (centreSportifUpdate) {
            	centreSportifUpdate.getGestionParticipant().ajouterJoueur(nomEquipe, Integer.parseInt(matricule));
            	List<String> listeMessageSucces = new LinkedList<String>();
            	listeMessageSucces.add("Inscription du participant: " + matricule + " dans l'équipe " + nomEquipe);
                request.setAttribute("listeMessageSucces", listeMessageSucces);
            }
            RequestDispatcher dispatcher = request.getRequestDispatcher("/WEB-INF/participants.jsp");
            dispatcher.forward(request, response);
    ...
    public void refuserJoueur(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
    	try {
    		String matricule = request.getParameter("matricule");
    		String nomEquipe = request.getParameter("nomEquipe");
    		if (matricule == null || matricule.equals(""))
            ...
            // sur biblio
            synchronized (centreSportifUpdate) {
            	centreSportifUpdate.getGestionParticipant().refuserJoueur(nomEquipe, Integer.parseInt(matricule));
            	List<String> listeMessageSucces = new LinkedList<String>();
            	listeMessageSucces.add("Refus du participant: " + matricule + " dans l'équipe " + nomEquipe);
                request.setAttribute("listeMessageSucces", listeMessageSucces);
            }
            RequestDispatcher dispatcher = request.getRequestDispatcher("/WEB-INF/participants.jsp");
            dispatcher.forward(request, response);
    ...
    public void supprimerJoueur(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
    	try {
    		String matricule = request.getParameter("matricule");
    		String nomEquipe = request.getParameter("nomEquipe");
    		if (matricule == null || matricule.equals(""))
            ...
            // sur biblio
            synchronized (centreSportifUpdate) {
            	centreSportifUpdate.getGestionParticipant().supprimerJoueur(nomEquipe, Integer.parseInt(matricule));
            	List<String> listeMessageSucces = new LinkedList<String>();
            	listeMessageSucces.add("Suppression du participant: " + matricule + " de l'équipe " + nomEquipe);
                request.setAttribute("listeMessageSucces", listeMessageSucces);
            }
            RequestDispatcher dispatcher = request.getRequestDispatcher("/WEB-INF/participants.jsp");
            dispatcher.forward(request, response);
    ...
    public void accepterJoueur(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
    	try {
    		String matricule = request.getParameter("matricule");
    		String nomEquipe = request.getParameter("nomEquipe");
    		if (matricule == null || matricule.equals(""))
            ...
            // sur biblio
            synchronized (centreSportifUpdate) {
            	centreSportifUpdate.getGestionParticipant().accepterJoueur(nomEquipe, Integer.parseInt(matricule));
            	List<String> listeMessageSucces = new LinkedList<String>();
            	listeMessageSucces.add("Ajout du participant: " + matricule + " dans l'équipe " + nomEquipe);
                request.setAttribute("listeMessageSucces", listeMessageSucces);
            }
            RequestDispatcher dispatcher = request.getRequestDispatcher("/WEB-INF/participants.jsp");
            dispatcher.forward(request, response);
	...
	public void inscrireParticipant(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
    	try {
    		String matricule = request.getParameter("matricule");
